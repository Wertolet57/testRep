...
export default class Toolbar {
  constructor(data, widthFn, isHide = false) {
    ...
    this.ddTextColor = new DropdownColor('color', style.color);
    this.ddFillColor = new DropdownColor('bgcolor', style.bgcolor);
    ...
    this.btnChildren = [
      ...
      this.redoEl = buildButtonWithIcon(`${t('toolbar.redo')} (Ctrl+Y)`, 'redo', () => this.change('redo')),
      ...
      buildDivider(),
      this.fontBoldEl = buildButtonWithIcon(`${t('toolbar.fontBold')} (Ctrl+B)`, 'font-bold', () => toggleChange.call(this, 'font-bold')),
      this.fontItalicEl = buildButtonWithIcon(`${t('toolbar.fontItalic')} (Ctrl+I)`, 'font-italic', () => toggleChange.call(this, 'font-italic')),
